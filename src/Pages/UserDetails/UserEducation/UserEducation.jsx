...
const UserEducation = () => {
  ...
  const { data: userEducations = [], refetch } = useQuery(
    ["userEducations"],
    async () => {
          ...
          {universitys?.map((university) => (
            ...
            >
              <div className="flex gap-4">
                ...
                <div className="flex">
                  <p>{university?.startyear}</p>-<p>{university?.endyear}</p>-
          ...
          {collages?.map((collage) => (
            ...
            >
              <div className="flex gap-5">
                ...
                <div className="flex">
                  <p>{collage?.startyear}</p>-<p>{collage?.endyear}</p>-
          ...
          {schools?.map((school) => (
            ...
            >
              <div className="flex gap-5">
                ...
                <h1>{school?.school}</h1>
                <div className="flex">
                  <p>{school?.startyear}</p>-<p>{school?.endyear}</p>-
