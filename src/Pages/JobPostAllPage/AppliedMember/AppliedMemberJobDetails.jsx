...
const AppliedMemberJobDetails = ({ posts, user }) => {
    console.log(posts)
  return (
    <div className=" bg-white shadow-md rounded-md mt-5 p-6 border border-green-300">
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center">
          ...
          />
          <div>
            <h2 className=" font-semibold text-gray-800">{posts?.jobTitle}</h2>
      ...
      <div className="flex bottom-0 justify-around mt-5 bg-gray-50 py-3 rounded-md">
