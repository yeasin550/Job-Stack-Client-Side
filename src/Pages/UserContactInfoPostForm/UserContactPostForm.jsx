...
const UserContactPostForm = () => {
    ...
    const onSubmit = data => {
        ...
        const contactInfo = {phoneNumber,currentLocation,homeLocation};
         axiosSequre.put(`/contactinfo/${_id}`, contactInfo)
            .then(data => {
    ...
    return (
        <div>
            <div className='flex justify-start items-center gap-2 mt-2 mb-2'>
                ...
                <label htmlFor="my_modal_3" className="link text-blue-500">Add Contact Info</label>
            </div>
            <div>
                ...
                <div className="modal">
                    <div className="modal-box">
                        <div className="modal-action">
                            <label htmlFor="my_modal_3" className="btn btn-circle bg-green-400 absolute top-3 right-3 text-white">X</label>
                        </div>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-control">
                                ...
                                <input {...register("phoneNumber")} type="number" placeholder="type here" className="input input-bordered" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Current City</span>
                                </label>
                                <input {...register("currentLocation")} type="text" placeholder="type here" className="input input-bordered" />
                            </div>
                            ...
                            <div className="form-control">
                                ...
                                <input {...register("homeLocation")} type="text" placeholder="type here" className="input input-bordered" />
                            </div>
