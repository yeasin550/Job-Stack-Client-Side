          ...
          <ul className="items-center justify-center text-center text-lg space-y-8 md:flex md:space-x-6 md:space-y-0">
            ...
            {user && (
              <li className="flex relative justify-center">
                ...
                {singlenotify && (
                  <div className="badge bg-green-800 text-white border-none absolute -top-2 left-16">
                    {singlenotify?.length}
                  </div>
                )}
              </li>
            ...
            <li>
              <div className="dropdown dropdown-hover">
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content z-[1] menu p-2 bg-white dark:bg-[#0E1320] rounded-box w-52"
                >
                  <li>
