...
const ChooseWork = () => {
  return (
    <div className="banner dark:bg-gradient-to-r from-gray-700 via-gray-900 to-black py-14 md:py-20">
      ...
      <div>
        <div className="grid md:grid-cols-4 lg:gap-5 gap-2 py-10 px-3 md:px-16 dark:text-black">
          <Work
          ...
          <Work
            ...
            description={" Gain a business in the most advanced IoT solutions."}
          />
        </div>
      </div>
    </div>
